...
#define ERROR_LIST_HELPER1 /* 1-100 */\
    ERROR_DEFINE_HELPER (SUCCESS = 0,                                           CATEGORY_SUCCESS,                            "Success.") /* Line-Tools do not print this string */ \
    ...
    ERROR_DEFINE_HELPER (INVALID_CSE_FILE_NAME,                                 CATEGORY_CSE_FILE_INVALID_INPUT_VALUE,       "The CSE File Component requested, File Name is not valid for this operation.") \
    ERROR_DEFINE_HELPER (ERROR_BG_MUST_BE_ENABLED_WHEN_PMF_IS_UNSIGNED,         CATEGORY_MEMANUF_BIST_TEST_FAILED,           "Boot Guard must be enabled when PMF is unsigned.") \
    ERROR_DEFINE_HELPER (FPT_INVALID_CONFIG_FORMAT,                             CATEGORY_USER_INPUT_FILE_ERROR,              "Failed to read FPT NVARs config file.") \
    ...
    ERROR_DEFINE_HELPER (ERROR_UNKNOWN_UNSUPPORTED_HW,                          CATEGORY_UNSUPPORTED_HW,                     "Unknown or unsupported hardware platform.") \
...
#define ERROR_LIST_HELPER4 /* 301-400 */\
    ...
    ERROR_DEFINE_HELPER (FWU_FLASH_CODE_PARTITION_INVALID,                      CATEGORY_FWU_FW_ERROR,                       "FTPR invalid.") \
    ERROR_DEFINE_HELPER (FWU_FLASH_NFT_PARTITION_INVALID,                       CATEGORY_FWU_FW_ERROR,                       "NFTP invalid.") \
    ...
    ERROR_DEFINE_HELPER (FWU_INVALID_SVN,                                       CATEGORY_FWU_FW_ERROR,                       "SVN invalid: SVN is too large.") \
    ...
    ERROR_DEFINE_HELPER (FWU_ERROR_INVALID_MANIFEST_SIZE,                       CATEGORY_FWU_FW_ERROR,                       "Manifest size in Update Image is too large.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_364,                                         CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 364.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_365,                                         CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 365.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_366,                                         CATEGORY_FWU_FW_ERROR,                       "Failed to verify signature of OEM or RoT key manifests. For example: Error on update from Production to Pre-Production.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_367,                                         CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 367.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_SKUMGR_FAILED,                               CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 368.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_CFGMGR_FAILED,                               CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 369.") \
    ...
    ERROR_DEFINE_HELPER (FWU_ERROR_371,                                         CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 371.") \
    ...
    ERROR_DEFINE_HELPER (FWU_ERROR_VER_MAN_FAILED_NPHY,                         CATEGORY_FWU_FW_ERROR,                       "Loader failed to verify manifest signature of NPHY.") \
    ...
    ERROR_DEFINE_HELPER (FWU_ERROR_GET_EXT_FAILED_NPHY,                         CATEGORY_FWU_FW_ERROR,                       "Some manifest extension is missing in NPHY. Wrong MEU Tool was used to create the partition.") \
...
#define ERROR_LIST_HELPER5 /* 401-500 */\
    ...
    ERROR_DEFINE_HELPER (FWU_ERROR_INTEGRITY_FAILED_IOMP,                       CATEGORY_FWU_FW_ERROR,                       "IOMP partition hash and calculated hash are not the same.\n" \
                                                                                                                             "If partition hash is zero - wrong MEU Tool was used to create the partition.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_INTEGRITY_FAILED_NPHY,                       CATEGORY_FWU_FW_ERROR,                       "NPHY partition hash and calculated hash are not the same.\n" \
                                                                                                                             "If partition hash is zero - wrong MEU Tool was used to create the partition.") \
    ...
    ERROR_DEFINE_HELPER (FWU_ERROR_API_VER_MAJOR_IOMP,                          CATEGORY_FWU_FW_ERROR,                       "IOMP must have the same major API version as the version inside the list in FTPR,\n" \
                                                                                                                             "in the Update Image for Full Update, in the Flash Image for Partial Update.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_API_VER_MAJOR_NPHY,                          CATEGORY_FWU_FW_ERROR,                       "NPHY must have the same major API version as the version inside the list in FTPR,\n" \
                                                                                                                             "in the Update Image for Full Update, in the Flash Image for Partial Update.") \
    ...
    ERROR_DEFINE_HELPER (FWU_ERROR_OPEN_IUP,                                    CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 455.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_SPI_IUP,                                     CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 456.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_ENABLED_INVALID,                             CATEGORY_FWU_FW_ERROR,                       "Invalid FW Update enabled state.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_PWR_FAILED,                                  CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 458.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_SPI_FAILED,                                  CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 459.") \
    ...
    ERROR_DEFINE_HELPER (FWU_ERROR_RESTORE_POINT_OFFSET_INVALID,                CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 461.") \
    ...
    ERROR_DEFINE_HELPER (FWU_ERROR_PG_FAILURE,                                  CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 476.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_IPK_FAILURE,                                 CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 477.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_FLUSH_NVM_ERR,                               CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 478.") \
...
#define ERROR_LIST_HELPER6 /* 501-600 */\
    ERROR_DEFINE_HELPER (FWU_ERROR_501,                                         CATEGORY_FWU_FW_ERROR,                       "Firmware update failed due to an internal error 501.") \
    ...
    ERROR_DEFINE_HELPER (MEMANUF_ERROR_CFG_FILE_UNKNOWN_TEST,                   CATEGORY_USER_INPUT_FILE_ERROR,              "Invalid config file. Unknown test name found - %s.") \
    ...
    ERROR_DEFINE_HELPER (FWU_ERROR_NVM_COMPAT_FTPR,                             CATEGORY_FWU_FW_ERROR,                       "Update FTPR must have the same NVM compatibility (SPI/UFS) as Flash FTPR.")\
    ERROR_DEFINE_HELPER (ICC_FW_ERROR_INCORRECT_API_VERSION,                    CATEGORY_ICC_FW_ERROR,                       "Incorrect API version.")\
    ERROR_DEFINE_HELPER (FWU_ERROR_NVM_COMPAT_RBEP,                             CATEGORY_FWU_FW_ERROR,                       "Update RBEP must have the same NVM compatibility (SPI/UFS) as Flash RBEP.")\
    ERROR_DEFINE_HELPER (FWU_ERROR_NVM_COMPAT_NFTP,                             CATEGORY_FWU_FW_ERROR,                       "Update NFTP must have the same NVM compatibility (SPI/UFS) as Flash NFTP.")\
    ERROR_DEFINE_HELPER (FWU_ERROR_NVM_COMPAT_IUP,                              CATEGORY_FWU_FW_ERROR,                       "Update IUP must have the same NVM compatibility (SPI/UFS) as Flash IUP.")\
...
#define ERROR_LIST_HELPER7 /* 601-700 */\
    ...
    ERROR_DEFINE_HELPER (MEMANUF_ERROR_EOL_PCHC_VERSIONCHECK,                   CATEGORY_MEMANUF_EOL_TEST_FAILED,            "PCHC FW version mismatch, actual value is - %s") \
    ERROR_DEFINE_HELPER (FWU_ERROR_ENGINEERING_PART,                            CATEGORY_FWU_FW_ERROR,                       "Update of partition between engineering build vs regular build is not allowed.")\
    ERROR_DEFINE_HELPER (ERROR_UNKNOWN_HW,                                      CATEGORY_UNSUPPORTED_HW,                     "Unknown hardware platform.") \
    ERROR_DEFINE_HELPER (ERROR_UNSUPPORTED_HW,                                  CATEGORY_UNSUPPORTED_HW,                     "Unsupported hardware platform. %s") \
    ERROR_DEFINE_HELPER (ERROR_CFG_FILE_CONTAINS_DUPLICATES,                    CATEGORY_USER_INPUT_FILE_ERROR,              "Input configurable file contains cse file name duplicates.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_API_VER_MAJOR_ISIF,                          CATEGORY_FWU_FW_ERROR,                       "ISIF must have the same major API version as the version inside the list in FTPR,\n" \
                                                                                                                             "in the Update Image for Full Update, in the Flash Image for Partial Update.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_INTEGRITY_FAILED_ISIF,                       CATEGORY_FWU_FW_ERROR,                       "ISIF partition hash and calculated hash are not the same. If partition hash is zero - wrong MEU Tool was used to create the partition.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_GET_EXT_FAILED_ISIF,                         CATEGORY_FWU_FW_ERROR,                       "Some manifest extension is missing in ISIF. Wrong MEU Tool was used to create the partition.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_VER_MAN_FAILED_ISIF,                         CATEGORY_FWU_FW_ERROR,                       "Loader failed to verify manifest signature of ISIF.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_API_VER_MAJOR_ISIC,                          CATEGORY_FWU_FW_ERROR,                       "ISIC must have the same major API version as the version inside the list in FTPR,\n" \
                                                                                                                             "in the Update Image for Full Update, in the Flash Image for Partial Update.") \
    ERROR_DEFINE_HELPER (FWU_ERROR_INTEGRITY_FAILED_ISIC,                       CATEGORY_FWU_FW_ERROR,                       "ISIC partition hash and calculated hash are not the same. If partition hash is zero - wrong MEU Tool was used to create the partition.") \
