...
const GUID&
FWUpdateCommand::getGUID()
{
	return FW_UPDATE_GUID;
}

std::vector<uint8_t>
FWUpdateCommandRequest::Serialize()
{
	FWUpdate_MESSAGE_HEADER header = 
...
std::vector<uint8_t>
FWUpdateCommandRequest::serializeHeader(const FWUpdate_MESSAGE_HEADER& header)
{
